...
<main>
    <header>
        <div>
            <h1>Sesiones</h1>
            <p>Índice del proyecto (hasta Sesión 9: filtros de prácticas).</p>
        </div>

        <div style="display:flex; gap:.6rem; flex-wrap:wrap;">
            <a class="btn btn-primary" href="{{ route('home') }}">Ir a inicio</a>
            <a class="btn" href="{{ route('admin.practicas.index') }}">Panel admin</a>
        </div>
    </header>
    ...
    <section>
        <h2>Sesión 7 – CRUD de prácticas</h2>
        <p>Gestión completa de prácticas relacionando alumnos, empresas y tutores.</p>
        <ul>
            <li><a href="{{ route('admin.practicas.index') }}">Gestión de prácticas</a></li>
            <li><a href="{{ route('admin.practicas.create') }}">Crear práctica</a></li>
        </ul>
        <ul>
            <li><code>app/Http/Controllers/Admin/PracticaController.php</code></li>
            <li><code>resources/views/admin/practicas/*.blade.php</code></li>
        </ul>
    </section>

    <section>
        <h2>Sesión 8 – Validación y tests</h2>
        <p>Control de errores y pruebas automáticas para mejorar la calidad del proyecto.</p>
        <ul>
            <li>Validación de formularios (controladores / requests)</li>
            <li>Tests automáticos (Feature / Unit)</li>
    ...
    <section>
        ...
        <p>Búsqueda y filtrado avanzado en listados.</p>
        <ul>
            <li>Filtros por alumno, empresa y tutor</li>
            <li>Parámetros GET</li>
