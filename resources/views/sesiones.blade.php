...
<main>
    <header>
        <div>
            <h1>Sesiones</h1>
            <p>Índice del proyecto (Sesión 3: BD, migraciones, seeders y Query Builder).</p>
        </div>
        ...
        <div style="display:flex; gap:.6rem; flex-wrap:wrap;">
            ...
            <a class="btn" href="{{ route('db.alumnos') }}">BD alumnos</a>
            <a class="btn" href="{{ route('db.practicas') }}">BD prácticas</a>
        </div>
    </header>
    ...
    <section>
        ...
        <p>Archivos relevantes:</p>
        <ul>
            <li><code>database/migrations</code> (tablas)</li>
            <li><code>database/seeders</code> (datos de prueba)</li>
            <li><code>app/Http/Controllers/DbPracticasController.php</code> (consultas)</li>
        </ul>
    </section>
